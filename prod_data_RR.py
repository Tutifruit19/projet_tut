...
while q==0:
    ...
    for w in range(len(list_lat)):
        ...
        #fig.show()
        fig.write_html('/home/mpma/henona/graph_test_RR_'+list_ville[w]+'.html')
        os.system("cp -f /home/mpma/henona/graph_test_RR_"+list_ville[w]+".html /home/mpma/henona/recovery_data/")
        os.system("/home/mpma/henona/ftp_script_RR.sh")
    time.sleep(21600)